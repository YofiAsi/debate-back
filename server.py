...
app = Flask(__name__)
origins = ["https://facebook.com/*", "https://*.facebook.com/*", "https://google.com/*", "https://*.google.com/*", "https://debate-center-dd720.web.app/*", "https://debate-center-dd720.firebaseapp.com/*"]
